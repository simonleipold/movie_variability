#!/usr/bin/env python
## this script creates dataframes from the upper triangle for control distance matrices (age, sex)
...
output_dir = Path('/project/3011157.03/Simon/proj_2022_CABB_movie/Scripts/MovVar_CommsBio_Revision01/control_length/dfs_control')
...
for con_var in ['age', 'sex']:
    ...
    if matrix_filename.exists():
        ...
        output_file_name = output_dir / f'Control_{con_var}_df_upper.csv'
