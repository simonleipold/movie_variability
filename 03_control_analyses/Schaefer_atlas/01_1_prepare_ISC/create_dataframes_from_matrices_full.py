#!/usr/bin/env python
"""
Create long-format dataframes from the full ISC similarity matrices
for each movie and Schaefer parcel.

Each output CSV contains the correlation value for each pair of subjects.
"""
...
print("\nFinished creating long-format ISC dataframes.")