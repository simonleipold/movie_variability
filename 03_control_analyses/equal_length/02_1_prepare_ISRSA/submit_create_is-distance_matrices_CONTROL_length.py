...
job_name = "create_is-distance_matrices_CONTROL_length" # Name of the job
output_file = f"{job_name}.out"
error_file = f"{job_name}.err"
script_to_run = "create_is-distance_matrices_CONTROL_length.py" # Name of the script to run
