...
## for both the full matrix and the upper triangle
...
all_pairs_full_path = data_dir / 'all_pair_list_with_reverse_hcp7T.csv'
all_pairs_upper_path = data_dir / 'all_pair_list_hcp7T.csv'
