#!/usr/bin/env python
"""
Create long-format neural distance dataframes from the full
subject-by-subject correlation-distance matrices for each movie and
Schaefer parcel.

Each output CSV contains the neural distance value for each ordered
pair of subjects.
"""
...
# ------------------------------------------------------------------
# load full all-pairs list, including reverse pairs
# ------------------------------------------------------------------
...
for movie in range(1, num_movies + 1):
    ...
    for node in range(1, num_nodes + 1):
        ...
        # ----------------------------------------------------------
        # extract pairwise neural distance values
        # ----------------------------------------------------------
        distance_data = []
...
print("\nFinished creating full neural distance dataframes.")