...
dir_out = os.path.join('/project', '3011157.03', 'Simon', 'proj_2022_CABB_movie', 'Scripts', 'MovVar_CommsBio_Revision01', 'control_corrdis', 'matrices')
...
# Features
tmp_mat = sio.loadmat(os.path.join(projpath, 'features_RDM_corr'))
feat_mat_raw = tmp_mat['B2'] # B and B2 are identical for correlation distances
# Naming
