...
r_path = os.path.join(proj_path, 'Scripts', 'MovVar_CommsBio_Revision01', 'control_length','r_output')
## location where visualizations and niftis will be stored
out_dir = os.path.join(proj_path, 'Scripts', 'MovVar_CommsBio_Revision01', 'control_length','r_output','formatted')
