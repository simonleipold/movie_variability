...
dir_out = os.path.join('/project', '3011157.03', 'Simon', 'proj_2022_CABB_movie', 'Scripts', 'MovVar_CommsBio_Revision01', 'control_length', 'matrices')
if not os.path.exists(dir_out):
    os.makedirs(dir_out, exist_ok = True)
    print('directory %s created' % (dir_out))

## where should the matrix visualizations be stored?
dir_out_vis = os.path.join('/project', '3011157.03', 'Simon', 'proj_2022_CABB_movie', 'Scripts', 'MovVar_CommsBio_Revision01', 'control_length', 'matrices', 'visualizations')
