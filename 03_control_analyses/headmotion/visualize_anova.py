...
in_path = os.path.join(proj_path, 'Scripts', 'MovVar_ImagNeuro_Revision01', 'control_motion', 'r_output_anova')
## location where visualizations and niftis will be stored
out_dir = os.path.join(proj_path, 'Scripts', 'MovVar_ImagNeuro_Revision01', 'control_motion', 'visualizations')
...
pvalues_csv = os.path.join(in_path, 'isc_anova_fd_residualized.csv')
# Load results data
