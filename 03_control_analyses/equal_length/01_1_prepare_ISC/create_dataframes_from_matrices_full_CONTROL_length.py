...
matrix_dir = Path('/project/3011157.03/Simon/proj_2022_CABB_movie/Scripts/MovVar_CommsBio_Revision01/control_length/matrices') # adapted to control length

# Directory to save the results
output_dir = Path('/project/3011157.03/Simon/proj_2022_CABB_movie/Scripts/MovVar_CommsBio_Revision01/control_length/dataframes') # adapted to control length
